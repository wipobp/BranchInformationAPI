...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("BranchInformationAPI")
            .description("Bank Branch Information API")
            .license("MIT")
            .licenseUrl("xyz-bank.com/licence")
            .termsOfServiceUrl("xyz-bank.com")
            .version("1.0.0")
            .contact(new Contact("","", "info@xyz-bank.com"))
            .build();
    }
